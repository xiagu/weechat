...
struct t_config_option *config_completion_nick_ignore_prefix_chars;
...
config_weechat_init_options ()
{
    ...
    config_completion_nick_ignore_chars = config_file_new_option (
        ...
        NULL, 0, 0, "[]`_-^", NULL, 0,
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    config_completion_nick_ignore_prefix_chars = config_file_new_option (
        weechat_config_file, ptr_section,
        "nick_ignore_prefix_chars", "string",
        N_("prefix characters to ignore when for nick completion"),
        NULL, 0, 0, "@(:", NULL, 0,
        NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
